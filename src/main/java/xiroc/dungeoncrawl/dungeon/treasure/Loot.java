...
public class Loot {
    ...
    public static ResourceLocation CHEST_STAGE_4 = DungeonCrawl.locate("chests/stage_4");
    public static ResourceLocation CHEST_STAGE_5 = DungeonCrawl.locate("chests/stage_5");
    ...
    public static ResourceLocation SECRET_ROOM = DungeonCrawl.locate("chests/secret_room");
