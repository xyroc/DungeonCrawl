...
public enum DecorationType {
    ...
    VINES(DungeonDecoration.VINE_DECORATION),
    SCATTERED(DungeonDecoration.SCATTERED_DECORATION, true),
    FLOOR(DungeonDecoration.FLOOR_DECORATION, true),
    FLOOR_NEXT_TO_SOLID(DungeonDecoration.FLOOR_NEXT_TO_SOLID_DECORATION, true);
