...
//	public static TreasureLootTable SMELTERY, MINECART, SECRET_ROOM, LIBRARY, BUILDERS_ROOM, TREASURE;
	...
	static {
		...
		MODEL_TREASURE_TYPES.put(35, Type.LIBRARY);
...
//				new TreasureEntry("minecraft:golden_apple", 1, 2, 1), new TreasureEntry("minecraft:music_disc_13", 1),
//				new TreasureEntry("minecraft:music_disc_cat", 1), new TreasureEntry("minecraft:name_tag", 1),
//				new TreasureEntry("minecraft:crossbow", 1), new TreasureEntry("minecraft:torch", 1, 7, 2),
//				new TreasureEntry("minecraft:brown_mushroom", 1, 4, 7), new TreasureEntry("minecraft:kelp", 1, 7, 15),
//				new TreasureEntry("minecraft:bowl", 7), new TreasureEntry("minecraft:clock", 1),
//				new TreasureEntry("minecraft:compass", 1), new TreasureEntry("minecraft:fermented_spider_eye", 3),
...
//		SUPPLY = new TreasureLootTable("supply_chest", null, CHEST_STAGE_1);
...
//		SUPPLY.entries.add(TreasureItems.RANDOM_SPECIAL_ITEM.withWeight(16));
...
//		
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_1);
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_1_OCEAN);
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_2);
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_2_OCEAN);
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_3);
//		TreasureLootTable.LOOT_TABLES.add(CHEST_STAGE_3_OCEAN);
//		TreasureLootTable.LOOT_TABLES.add(DISPENSER_STAGE_1);
//		TreasureLootTable.LOOT_TABLES.add(DISPENSER_STAGE_2);
//		TreasureLootTable.LOOT_TABLES.add(DISPENSER_STAGE_3);
//		TreasureLootTable.LOOT_TABLES.add(SUPPLY);
