...
public class Loot {
	...
	public static ResourceLocation CHEST_STAGE_1_OCEAN = CHEST_STAGE_1;//DungeonCrawl.locate("loot_tables/chests/stage_1_ocean");
	public static ResourceLocation CHEST_STAGE_2 = DungeonCrawl.locate("chests/stage_2");
	public static ResourceLocation CHEST_STAGE_2_OCEAN = CHEST_STAGE_2;//DungeonCrawl.locate("loot_tables/chests/stage_2_ocean");
	public static ResourceLocation CHEST_STAGE_3 = DungeonCrawl.locate("chests/stage_3");
	public static ResourceLocation CHEST_STAGE_3_OCEAN = CHEST_STAGE_3;//DungeonCrawl.locate("loot_tables/chests/stage_3_ocean");
