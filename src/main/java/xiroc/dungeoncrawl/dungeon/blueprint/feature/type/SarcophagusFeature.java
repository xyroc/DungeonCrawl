...
public record SarcophagusFeature(Anchor placement, Delegate<SpawnerType> spawnerType, Optional<ResourceLocation> lootTable) implements PlacedFeature {
    ...
    public void place(WorldGenLevel level, Random random, BoundingBox worldGenBounds, PrimaryTheme primaryTheme, SecondaryTheme secondaryTheme, int stage) {
        ...
        WorldEditor.placeStairs(level, stair, pos, worldGenBounds, Half.BOTTOM, placement.direction().getOpposite(), random, true, true, true);
        WorldEditor.placeStairs(level, stair, pos.relative(placement.direction(), 4), worldGenBounds, Half.BOTTOM, placement.direction(), random, true, true, true);
        ...
        WorldEditor.placeStairs(level, stair, pos.above(), worldGenBounds, Half.TOP, placement.direction().getOpposite(), random, true, true, true);
        WorldEditor.placeStairs(level, stair, pos.above().relative(placement.direction(), 4), worldGenBounds, Half.TOP, placement.direction(), random, true, true, true);

        WorldEditor.placeStairs(level, stair, pos.above(2), worldGenBounds, Half.BOTTOM, placement.direction().getOpposite(), random, true, true, true);
        WorldEditor.placeStairs(level, stair, pos.above(2).relative(placement.direction(), 4), worldGenBounds, Half.BOTTOM, placement.direction(), random, true, true, true);
        ...
        WorldEditor.placeBlock(level, secondaryTheme.material(), placement.position(), worldGenBounds, random, true, true, true);
    }
}
