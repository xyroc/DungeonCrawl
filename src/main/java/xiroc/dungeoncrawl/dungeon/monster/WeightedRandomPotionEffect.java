...
public class WeightedRandomPotionEffect implements IRandom<WeightedRandomPotionEffect.WeightedEntry> {
    ...
    private void assign(Builder.Entry[] entries, int totalWeight) {
        ...
        for (Builder.Entry entry : entries) {
            ...
            this.entries[i] = new WeightedRandomPotionEffect.WeightedEntry(ForgeRegistries.MOB_EFFECTS.getValue(new ResourceLocation(entry.effect)), entry.duration, entry.amplifier, weight + f);
            f += weight;
            i++;
        }
    }
    ...
    public static WeightedRandomPotionEffect fromJson(JsonArray array) {
        ...
        array.forEach((element) -> {
            ...
            RandomValue level = object.has("amplifier") ? RandomValue.deserialize(object.get("amplifier")) : new Constant(0);
    ...
    public record WeightedEntry(MobEffect effect, int duration,
                                RandomValue amplifier, float weight) {
    ...
    public static class Builder {
        ...
        public WeightedRandomPotionEffect.Builder add(String effect, int duration, RandomValue level, int weight) {
        ...
        private static class Entry {
            ...
            public final RandomValue amplifier;
            public final int weight;

            public Entry(String effect, int duration, RandomValue amplifier, Integer weight) {
                this.effect = effect;
