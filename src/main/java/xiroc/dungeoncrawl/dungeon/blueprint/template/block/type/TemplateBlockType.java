...
public interface TemplateBlockType extends BlockChooser {
    ...
    static void register(final RegisterEvent.RegisterHelper<MapCodec<? extends TemplateBlockType>> registry) {
        ...
        registry.register(DungeonCrawl.locate("masonry/pillar"), MASONRY_PILLAR.getCodec());
        registry.register(DungeonCrawl.locate("masonry/stairs"), MASONRY_STAIRS.getCodec());
        registry.register(DungeonCrawl.locate("masonry/slab"), MASONRY_SLAB.getCodec());
        registry.register(DungeonCrawl.locate("material"), MATERIAL.getCodec());
        registry.register(DungeonCrawl.locate("material/pillar"), MATERIAL_PILLAR.getCodec());
        registry.register(DungeonCrawl.locate("material/slab"), MATERIAL_SLAB.getCodec());
        registry.register(DungeonCrawl.locate("material/stairs"), MATERIAL_STAIRS.getCodec());
