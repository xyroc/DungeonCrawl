...
public class VineDecoration implements DungeonDecoration {
    ...
    @Override
    public void decorate(DungeonModel model, IWorld world, BlockPos pos, Random random, MutableBoundingBox worldGenBounds, MutableBoundingBox structureBounds, DungeonPiece piece) {
