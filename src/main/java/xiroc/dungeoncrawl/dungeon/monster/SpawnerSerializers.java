...
public interface SpawnerSerializers {
    static void gsonAdapters(GsonBuilder builder) {
        builder.registerTypeAdapter(SpawnerEntityProperties.Builder.class, InheritingBuilder.WrappedSerializer.of(new SpawnerEntityProperties.BuilderSerializer()))
                ...
                .registerTypeAdapter(SpawnerEntityType.Types.RANDOM_BUILDER, new IRandom.BuilderSerializer<Delegate<SpawnerEntityType>>(SpawnerEntityType.Types.DELEGATE, "entity"))
                ...
                .registerTypeAdapter(SpawnerType.Types.RANDOM_BUILDER, new IRandom.BuilderSerializer<Delegate<SpawnerType>>(SpawnerType.Types.DELEGATE, "type"))
