    ...
    private static class Condition<T> {
        ...
        public static Condition<?> fromJson(JsonElement element, String name) {
            switch (name) {
                ...
                case "multipart_north":
                    return new Condition<>(Property.MULTIPART_NORTH, element.getAsBoolean());
                case "multipart_east":
                    return new Condition<>(Property.MULTIPART_EAST, element.getAsBoolean());
                case "multipart_south":
                    return new Condition<>(Property.MULTIPART_SOUTH, element.getAsBoolean());
                case "multipart_west":
                    return new Condition<>(Property.MULTIPART_WEST, element.getAsBoolean());
                case "straight":
