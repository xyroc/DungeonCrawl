...
public class DungeonCrawl {
     ...
     */
    public static List<String> BIOME_BLACKLIST = Lists.newArrayList("minecraft:the_end", "minecraft:nether",
     ...
     */
    public static List<String> BIOME_OVERWORLD_BLACKLIST = Lists.newArrayList("minecraft:ocean", "minecraft:deep_ocean",
	    "minecraft:warm_ocean", "minecraft:lukewarm_ocean", "minecraft:cold_ocean", "minecraft:deep_warm_ocean",
