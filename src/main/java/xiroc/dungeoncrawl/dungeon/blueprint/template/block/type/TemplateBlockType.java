...
public interface TemplateBlockType extends BlockChooser {
    Codec<? extends TemplateBlockType> codec();
    ...
    ImmutableBiMap<String, Codec<? extends TemplateBlockType>> CODECS = ImmutableBiMap.<String, Codec<? extends TemplateBlockType>>builder()
