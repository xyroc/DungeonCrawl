...
public record CorridorArchSegment(ImmutableMap<ResourceLocation, ImmutableList<Anchor>> anchors, ImmutableList<BlueprintFeature> features) implements Blueprint {
    @Override
