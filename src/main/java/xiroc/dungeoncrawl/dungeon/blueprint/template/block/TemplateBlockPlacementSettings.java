...
public record TemplateBlockPlacementSettings(boolean fillAir, boolean fillSolid, @Nullable TemplateBlockType alternative) {
    public static final Codec<TemplateBlockPlacementSettings> CODEC = RecordCodecBuilder.create(instance ->
            ...
            ).apply(instance, (fillAir, fillSolid, alternative) -> new TemplateBlockPlacementSettings(fillAir, fillSolid, alternative.orElse(null))));

    public static final TemplateBlockPlacementSettings NON_SOLID_PLACEMENT = new TemplateBlockPlacementSettings(false, true, null);
    public static final TemplateBlockPlacementSettings SOLID_PLACEMENT = new TemplateBlockPlacementSettings(true, true, null);
